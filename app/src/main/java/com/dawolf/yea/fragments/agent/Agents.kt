...
import com.dawolf.yea.databinding.FragmentAgentsBinding
 ...
 * Use the [Agents.newInstance] factory method to
...
class Agents : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentAgentsBinding.bind(view)
...
//            binding.recycler.adapter = recyclerViewAgents
    ...
    companion object {
         ...
         * @return A new instance of fragment Agents.
         */
