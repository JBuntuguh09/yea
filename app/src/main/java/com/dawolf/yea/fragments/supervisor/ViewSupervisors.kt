 ...
 * Use the [ViewSupervisors.newInstance] factory method to
 * create an instance of this fragment.
 */
class ViewSupervisors : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private lateinit var binding: FragmentViewSupervisorsBinding
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_view_supervisors, container, false)
        binding = FragmentViewSupervisorsBinding.bind(view)
    ...
    companion object {
         ...
         * @return A new instance of fragment ViewSupervisors.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ViewSupervisors().apply {
