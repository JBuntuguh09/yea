...
/**
 * Created by Infoview on 1/24/2018.
 */

public class My_ColorTemplate {
    ...
    public static final int[] MyColors_Main = {
            Color.rgb(255, 0, 0), Color.rgb(255,255,102), Color.rgb(0, 255, 0),
            Color.rgb(191, 134, 134), Color.rgb(179, 48, 80),
            Color.rgb(217, 80, 138), Color.rgb(254, 149, 7), Color.rgb(254, 247, 120),
            Color.rgb(106, 167, 134), Color.rgb(53, 194, 209),
            Color.rgb(192, 255, 140), Color.rgb(255, 247, 140), Color.rgb(255, 208, 140),
    ...
    public static final int[] COLORFUL_COLORS = {
            ...
            Color.rgb(255,224,114), Color.rgb(126,216,236)
    };
    ...
    public static final int[] MONEYCOLOR = {
            Color.rgb(241, 96, 55), Color.rgb(106, 178, 4), Color.rgb(111,166,230)
