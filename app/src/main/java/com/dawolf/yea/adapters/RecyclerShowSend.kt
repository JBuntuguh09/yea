...
class RecyclerShowSend(context: Context, arrayList: ArrayList<HashMap<String, String>>):
    RecyclerView.Adapter<RecyclerShowSend.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerShowSend.MyHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_pop_send_item,parent, false)

        return MyHolder(view)
    }

    override fun onBindViewHolder(holder: RecyclerShowSend.MyHolder, position: Int) {
